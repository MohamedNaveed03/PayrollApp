...
namespace PayrollApp.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Employees.Include(e => e.JobTitle);
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,JobTitleId,YearsWorked")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,JobTitleId,YearsWorked")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
